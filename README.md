...
- **Pandas:** Limpeza, conversão e manipulação de séries temporais para alinhar o fuso horário (UTC para SP).

---

Desenvolvido com ☕ e Matemática Orbital durante o voo da Artemis II.
